<template>
  <div class="app-container">
    <div class="dashboard-container">
      <header>
        <div class="dashboard-text"> <center>In Depth Analysis Module:</center> {{ name }}</div>
      </header>
      <p class="card-title-desc"> This module aims to provide researchers with commonly applied scRNA-seq analysis algorithms to interpret human lung transcriptomic data from a more systematic perspective.
        So far, researchers are able to perform
        <code class="highlighter-rouge">Trajectory Inference (Slingshot, Monocle, scVelo)</code>, <code class="highlighter-rouge">CellChat</code>,
        <code class="highlighter-rouge">SCENIC</code>, <code class="highlighter-rouge">Genes/Cells Regulatory Networks</code>, and <code class="highlighter-rouge">Survival Analysis</code>
